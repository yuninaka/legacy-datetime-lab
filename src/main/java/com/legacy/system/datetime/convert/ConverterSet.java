...
/**
 * A set of converters, which allows exact converters to be quickly selected. This class is
 * threadsafe because it is (essentially) immutable.
 *
...
class ConverterSet {
  ...
  /**
   * Returns a copy of this set, with the given converter added. If a matching converter is already
   * in the set, the given converter replaces it. If the converter is exactly the same as one
   * already in the set, the original set is returned.
   *
  ...
  /**
   * Returns a copy of this set, with the given converter removed. If the converter was not in the
