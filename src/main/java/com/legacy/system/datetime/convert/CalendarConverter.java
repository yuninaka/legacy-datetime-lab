...
import com.legacy.system.datetime.chrono.BuddhistChronology;
import com.legacy.system.datetime.chrono.GJChronology;
import com.legacy.system.datetime.chrono.GregorianChronology;
import com.legacy.system.datetime.chrono.ISOChronology;
import com.legacy.system.datetime.chrono.JulianChronology;
import java.util.Calendar;
import java.util.GregorianCalendar;

/**
 * CalendarConverter converts a java util Calendar to an instant or partial. The Calendar is
 * converted to milliseconds and the chronology that best matches the calendar.
 *
...
final class CalendarConverter extends AbstractConverter
   ...
   * Gets the chronology.
   *
   * <p>If a chronology is specified then it is used. Otherwise, it is the GJChronology if a
   * GregorianCalendar is used, BuddhistChronology if a BuddhistCalendar is used or ISOChronology
   * otherwise. The time zone is extracted from the calendar if possible, default used if not.
   *
   ...
   * BuddhistChronology if a BuddhistCalendar is used or ISOChronology otherwise. The time zone
   * specified is used in preference to that on the calendar.
   *
   * @param object the Calendar to convert, must not be null
