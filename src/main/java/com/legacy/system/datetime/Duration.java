...
import com.legacy.system.datetime.base.BaseDuration;
 ...
 *
 * <p>A duration is defined by a fixed number of milliseconds. There is no concept of fields, such
 * as days or seconds, as these fields can vary in length.
 *
 * <p>A duration may be converted to a {@link Period} to obtain field values. This conversion will
 * typically cause a loss of precision.
 *
 * <p>Duration is thread-safe and immutable.
 *
...
public final class Duration extends BaseDuration implements ReadableDuration, Serializable {
   ...
   *
   * <p>This parses the format {@code PTa.bS}, as per {@link #toString()}.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Create a duration with the specified number of days assuming that there are the standard number
   * of milliseconds in a day.
   *
   * <p>This method assumes that there are 24 hours in a day, 60 minutes in an hour, 60 seconds in a
   * minute and 1000 milliseconds in a second. This will be true for most days, however days with
   * Daylight Savings changes will not have 24 hours, so use this method with care.
   *
   * <p>A Duration is a representation of an amount of time. If you want to express the concept of
   * 'days' you should consider using the {@link Days} class.
   *
  ...
  /**
   * Create a duration with the specified number of hours assuming that there are the standard
   * number of milliseconds in an hour.
   *
   * <p>This method assumes that there are 60 minutes in an hour, 60 seconds in a minute and 1000
   * milliseconds in a second. All currently supplied chronologies use this definition.
   *
   * <p>A Duration is a representation of an amount of time. If you want to express the concept of
   * 'hours' you should consider using the {@link Hours} class.
   *
  ...
  /**
   * Create a duration with the specified number of minutes assuming that there are the standard
   * number of milliseconds in a minute.
   *
   * <p>This method assumes that there are 60 seconds in a minute and 1000 milliseconds in a second.
   * All currently supplied chronologies use this definition.
   *
   * <p>A Duration is a representation of an amount of time. If you want to express the concept of
   * 'minutes' you should consider using the {@link Minutes} class.
   *
  ...
  /**
   * Create a duration with the specified number of seconds assuming that there are the standard
   * number of milliseconds in a second.
   *
   * <p>This method assumes that there are 1000 milliseconds in a second. All currently supplied
   * chronologies use this definition.
   *
   * <p>A Duration is a representation of an amount of time. If you want to express the concept of
   * 'seconds' you should consider using the {@link Seconds} class.
   *
  ...
  /**
   * Creates a duration from the specified object using the {@link
  ...
  // -----------------------------------------------------------------------
  /**
   * Gets the length of this duration in days assuming that there are the standard number of
   ...
   * Daylight Savings changes will not have 24 hours, so use this method with care.
   *
   * <p>This returns <code>getMillis() / MILLIS_PER_DAY</code>. The result is an integer division,
  ...
  /**
   * Gets the length of this duration in hours assuming that there are the standard number of
   * milliseconds in an hour.
   *
   * <p>This method assumes that there are 60 minutes in an hour, 60 seconds in a minute and 1000
   * milliseconds in a second. All currently supplied chronologies use this definition.
   *
   * <p>This returns <code>getMillis() / MILLIS_PER_HOUR</code>. The result is an integer division,
   * thus excess milliseconds are truncated.
   *
  ...
  /**
   * Gets the length of this duration in minutes assuming that there are the standard number of
   * milliseconds in a minute.
   *
   * <p>This method assumes that there are 60 seconds in a minute and 1000 milliseconds in a second.
   * All currently supplied chronologies use this definition.
   *
   * <p>This returns <code>getMillis() / MILLIS_PER_MINUTE</code>. The result is an integer
   * division, thus excess milliseconds are truncated.
   *
  ...
  /**
   * Gets the length of this duration in seconds assuming that there are the standard number of
   * milliseconds in a second.
   *
   * <p>This method assumes that there are 1000 milliseconds in a second. All currently supplied
   * chronologies use this definition.
   *
   * <p>This returns <code>getMillis() / 1000</code>. The result is an integer division, so 2999
   * millis returns 2 seconds.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Get this duration as an immutable <code>Duration</code> object by returning <code>this</code>.
   *
  ...
  /**
   * Converts this duration to a period in days assuming that there are the standard number of
   * milliseconds in a day.
   *
   * <p>This method assumes that there are 24 hours in a day, 60 minutes in an hour, 60 seconds in a
   * minute and 1000 milliseconds in a second. This will be true for most days, however days with
  ...
  /**
   * Converts this duration to a period in hours assuming that there are the standard number of
   * milliseconds in an hour.
   *
   * <p>This method assumes that there are 60 minutes in an hour, 60 seconds in a minute and 1000
   * milliseconds in a second. All currently supplied chronologies use this definition.
  ...
  /**
   * Converts this duration to a period in minutes assuming that there are the standard number of
   * milliseconds in a minute.
   *
   * <p>This method assumes that there are 60 seconds in a minute and 1000 milliseconds in a second.
   * All currently supplied chronologies use this definition.
  ...
  /**
   * Converts this duration to a period in seconds assuming that there are the standard number of
   * milliseconds in a second.
   *
   * <p>This method assumes that there are 1000 milliseconds in a second. All currently supplied
   * chronologies use this definition.
  ...
  /**
   * Returns a new duration with this length plus that specified multiplied by the scalar. This
   * instance is immutable and is not altered.
   *
   * <p>If the addition is zero, this instance is returned.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns a new duration with this length plus that specified. This instance is immutable and is
   * not altered.
   *
   * <p>If the addition is zero, this instance is returned.
   *
   ...
   * not altered.
   *
   * <p>If the amount is zero, this instance is returned.
   *
  ...
  /**
   * Returns a new duration with this length minus that specified. This instance is immutable and is
   * not altered.
   *
   * <p>If the addition is zero, this instance is returned.
   *
  ...
  /**
   * Returns a new duration with this length multiplied by the specified multiplicand. This instance
   * is immutable and is not altered.
   *
   * <p>If the multiplicand is one, this instance is returned.
   *
  ...
  /**
   * Returns a new duration with this length divided by the specified divisor. This instance is
   * immutable and is not altered.
   *
   * <p>If the divisor is one, this instance is returned.
   *
  ...
  /**
   * Returns a new duration with its length divided by the specified divisor. {@code RoundingMode}
   * can be specified. This instance is immutable and is not altered.
   *
   * <p>If the divisor is one, this instance is returned.
   *
   * @param divisor the divisor to divide this one by
   ...
   *
   * <p>This instance is immutable and is not altered.
   *
