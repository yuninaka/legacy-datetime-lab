...
/**
 * Abstract Chronology for implementing chronologies based on Gregorian/Julian formulae. Most of the
 * utility methods required by subclasses are package-private, reflecting the intention that they be
 * defined in the same package.
 *
 * <p>BasicGJChronology is thread-safe and immutable, and all subclasses must be as well.
 *
