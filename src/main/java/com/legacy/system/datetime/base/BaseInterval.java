...
import com.legacy.system.datetime.MutableInterval;
import com.legacy.system.datetime.ReadWritableInterval;
import com.legacy.system.datetime.ReadableDuration;
import com.legacy.system.datetime.ReadableInstant;
import com.legacy.system.datetime.ReadableInterval;
...
import com.legacy.system.datetime.convert.IntervalConverter;
import com.legacy.system.datetime.field.FieldUtils;
import java.io.Serializable;

/**
 * BaseInterval is an abstract implementation of ReadableInterval that stores data in two <code>long
 * </code> millisecond fields.
 *
 * <p>This class should generally not be used directly by API users. The {@link ReadableInterval}
 * interface should be used when different kinds of interval objects are to be referenced.
 *
 * <p>BaseInterval subclasses may be mutable and not thread-safe.
 *
...
public abstract class BaseInterval extends AbstractInterval
  ...
  /**
   * Constructs a time interval converting or copying from another object that describes an
   * interval.
   *
