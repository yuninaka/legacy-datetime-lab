 ...
 *
 * <p>This DateTimeField is useful for defining DateTimeFields that are composed of precise
 * durations, like time of day fields. If either duration field is imprecise, then an {@link
 * ImpreciseDateTimeField} may be used instead.
 *
 * <p>PreciseDateTimeField is thread-safe and immutable.
 *
...
public class PreciseDateTimeField extends PreciseDurationDateTimeField {
   ...
   * @throws IllegalArgumentException if unit milliseconds is less than one or effective value range
   *     is less than two.
   */
  ...
  /**
   * Add to the component of the specified time instant, wrapping around within that component if
   * necessary.
   *
  ...
  public long addWrapField(long instant, int amount) {
    ...
    int wrappedValue =
        FieldUtils.getWrappedValue(thisValue, amount, getMinimumValue(), getMaximumValue());
  ...
  /**
   * Returns the range duration of this field. For example, if this field represents "minute of
   * hour", then the range duration field is an hours.
   *
