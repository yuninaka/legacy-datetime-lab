 ...
 * </ul>
 *
 * <p>PeriodType is thread-safe and immutable, and all subclasses must be as well.
 *
...
public class PeriodType implements Serializable {
  ...
  // -----------------------------------------------------------------------
  /**
   * Compares this type to another object. To be equal, the object must be a PeriodType with the
   * same set of fields.
   *
