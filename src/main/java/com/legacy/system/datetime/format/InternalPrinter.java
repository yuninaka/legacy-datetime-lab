 ...
 *
 * <p>This has been separated from {@link DateTimePrinter} to avoid code duplication.
 *
...
interface InternalPrinter {
  ...
  /**
   * Returns the expected maximum number of characters produced. The actual amount should rarely
